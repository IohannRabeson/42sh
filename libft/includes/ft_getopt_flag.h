...
/*   Updated: 2014/05/14 21:48:59 by irabeson         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
typedef void(*t_go_init_flag_func)(t_go_flag *, char const *, t_ui);
...
void			go_init_dash_value_flag(t_go_flag *flag, char const *arg,
										t_ui i);
void			go_init_ddash_value_flag(t_go_flag *flag, char const *arg,
											t_ui i);
void			go_init_key_value_flag(t_go_flag *flag, char const *arg,
										t_ui i);
